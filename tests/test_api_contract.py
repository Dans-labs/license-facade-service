...
def test_openapi_security_scheme_marks_only_protected_operations(app_client):
    ...
    protected = {
        ...
        ("post", "/api/v1/admin/federation/signing-keys/inspect"),
        ("post", "/api/v1/admin/federation/signing-keys/stage"),
        ("post", "/api/v1/admin/federation/signing-keys/{kid}/schedule-activation"),
        ("post", "/api/v1/admin/federation/signing-keys/{kid}/cancel-schedule"),
        ("post", "/api/v1/admin/federation/signing-keys/{kid}/activate"),
        ("post", "/api/v1/admin/federation/signing-keys/{kid}/retire"),
        ("post", "/api/v1/admin/federation/signing-keys/{kid}/revoke-emergency"),
