...
8. Federation Phase 1 adds canonical PostgreSQL schema initialization and feature-gated runtime wiring without changing public licence endpoint semantics.
