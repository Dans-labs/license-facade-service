...
8. Federation Phase 1 adds Alembic-managed PostgreSQL schema initialization and feature-gated runtime wiring without changing public licence endpoint semantics.
